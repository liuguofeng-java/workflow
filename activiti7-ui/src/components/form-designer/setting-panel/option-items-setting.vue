<template>
  <div class="option-items-pane">
    ...
    <div v-else-if="selectedWidget.type === 'cascader'" class="full-width-input">
      <el-cascader v-model="optionModel.defaultValue" :options="optionModel.optionItems" @change="emitDefaultValueChange" :placeholder="i18nt('render.hint.selectPlaceholder')"> </el-cascader>
    </div>

  ...
  <el-form-item prop="name" :rules="nameRequiredRule">
    <template #label>
      <span
        ...
        <el-tooltip effect="light" :content="i18nt('designer.setting.editNameHelp')"> <svg-icon icon-class="el-info" /></el-tooltip>
      </span>
    </template>
...
import { isEmptyStr } from "@/components/form-designer/utils/util";

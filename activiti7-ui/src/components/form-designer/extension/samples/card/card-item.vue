...
<script>
  ...
  import ContainerItemWrapper from '@/components/form-designer/form-render/container-item/container-item-wrapper'
  import containerItemMixin from "@/components/form-designer/form-render/container-item/containerItemMixin"

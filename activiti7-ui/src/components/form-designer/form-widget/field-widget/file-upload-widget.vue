<template>
  ...
  >
    ...
    >
      ...
      <template #default> <svg-icon icon-class="el-plus" /><i class="el-icon-plus avatar-uploader-icon"></i> </template>
      <template #file="{ file }">
        <div class="upload-file-list">
          <span class="upload-file-name" :title="file.name">{{ file.name }}</span>
          <a :href="file.url" download="" target="_blank">
            <span class="el-icon-download file-action" :title="i18nt('render.hint.downloadFile')"> <svg-icon icon-class="el-download" /> </span
          ></a>
...
import i18n, { translate } from "@/components/form-designer/utils/i18n";
import { deepClone, evalFn } from "@/components/form-designer/utils/util";

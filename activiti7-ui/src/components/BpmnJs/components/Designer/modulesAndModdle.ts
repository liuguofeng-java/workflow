...
import camundaModdleDescriptors from "@/components/BpmnJs/moddle-extensions/camunda.json";
import flowableModdleDescriptors from "@/components/BpmnJs/moddle-extensions/flowable.json";
import MiyueModdleDescriptors from "@/components/BpmnJs/moddle-extensions/miyue.json";
...
import Rules from "@/components/BpmnJs/additional-modules/Rules";
import AutoPlace from "@/components/BpmnJs/additional-modules/AutoPlace";
import ElementFactory from "@/components/BpmnJs/additional-modules/ElementFactory";
import EnhancementPalette from "@/components/BpmnJs/additional-modules/Palette/EnhancementPalette";
import RewritePalette from "@/components/BpmnJs/additional-modules/Palette/RewritePalette";
import EnhancementContextPad from "@/components/BpmnJs/additional-modules/ContextPad/EnhancementContextPad";
import RewriteContextPad from "@/components/BpmnJs/additional-modules/ContextPad/RewriteContextPad";
import EnhancementRenderer from "@/components/BpmnJs/additional-modules/Renderer/EnhancementRenderer";
import RewriteRenderer from "@/components/BpmnJs/additional-modules/Renderer/RewriteRenderer";
